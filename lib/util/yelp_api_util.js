...
export const fetchSomeYelpLocations = (term, latitude, longitude, categories = "") => (
  $.ajax({
    url: `https://api.yelp.com/v3/businesses/search?latitude=${latitude}&longitude=${longitude}&term=${term}&categories=${categories}`
  })
);
